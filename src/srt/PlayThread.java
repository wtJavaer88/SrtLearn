...
{// 两个音频间的播放延迟
	...
	private long palyVoice()
	{
		...
		Queue<String> srtVoicesWithBg = SrtTextHelper.getSrtVoicesInRange(DataHolder.getFileKey(), currentSrtInfo.getFromTime().toString(), currentSrtInfo.getToTime().toString());
