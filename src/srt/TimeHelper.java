...
public class TimeHelper
{
    ...
    {
        List<String> patternStrings = PatternUtil.getPatternStrings(seekTime,
                "\\d+");
        ...
        return BasicStringUtil.fillLeftString(hour + "", 2, "0") + ":"
                + BasicStringUtil.fillLeftString(minute + "", 2, "0") + ":"
                + BasicStringUtil.fillLeftString(seconds + "", 2, "0") + ",000";
    }
    ...
    {
        List<String> patternStrings = PatternUtil.getPatternStrings(timeStr,
                "\\d+");
        int hour = BasicNumberUtil.getNumber(patternStrings.get(0));
        int minute = BasicNumberUtil.getNumber(patternStrings.get(1));
        int seconds = BasicNumberUtil.getNumber(patternStrings.get(2));
