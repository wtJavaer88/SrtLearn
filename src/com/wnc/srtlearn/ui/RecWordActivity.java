...
public class RecWordActivity extends BaseHorActivity implements OnClickListener,
        ...
        AfterWheelChooseListener
{
    ...
    private void initView()
    {
        ...
        ((Button) findViewById(R.id.btn_recword))
                .setOnClickListener(recClickListener);
        ((Button) findViewById(R.id.btn_recdialog))
                .setOnClickListener(recClickListener);
        ((Button) findViewById(R.id.btn_reccustom))
                .setOnClickListener(recClickListener);
        ((Button) findViewById(R.id.btn_recrepeat))
                .setOnClickListener(recClickListener);
    ...
    public class RecClickListener implements OnClickListener
    {
        ...
        public void onClick(View v)
        {
            ...
            case R.id.btn_recdialog:
                READ_MODE = 2;
                et.setVisibility(View.INVISIBLE);
                ((TextView) findViewById(R.id.tv_rectip)).setText("整段 <"
                        + dialog + "> 朗读:");
                speakChs_Baidu();
                break;
            case R.id.btn_reccustom:
                ...
                if (dialog.length() > 1)
                {
                    WheelDialogShowUtil.showCustomHanziDialog(
                            RecWordActivity.this, dialog, selIndexs[0],
                            selIndexs[1], RecWordActivity.this);
                }
                else
                {
                    ToastUtil.showLongToast(RecWordActivity.this,
                            "字数太少, 不需要自定义");
                }
                break;
    ...
    private boolean equalsNoSymbol(String paramStr1, String paramStr2)
    {
        ...
        System.out.println(TextFormatUtil.getTextNoSymbol(paramStr1) + " "
    ...
    {
        selIndexs[0] = Integer.parseInt(objs[0].toString());
        selIndexs[1] = Integer.parseInt(objs[1].toString());
        curSelContent = dialog.substring(selIndexs[0], 1 + selIndexs[1]);
