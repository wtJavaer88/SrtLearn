 ...
 * 
 */
public class VideoActivity extends Activity implements OnClickListener, UncaughtExceptionHandler, CtrlableHorGestureDetectorListener, CtrlableVerGestureDetectorListener, CtrlableDoubleClickGestureDetectorListener, Favoritable
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		this.gestureDetector = new GestureDetector(this, new MyCtrlableGestureDetector(this, 0.15, 0.2, this, this).setDclistener(this));
		init();
		toLandscapeScreen();
		initData();
		// initHoldPlay();
	...
	private void replaySetting()
	{
		...
		replaySettingDialog.getWindow().setLayout((int) (Math.min(MyAppParams.getScreenWidth(), MyAppParams.getScreenHeight()) * 0.8), android.view.WindowManager.LayoutParams.WRAP_CONTENT);
		...
		TextView btnReset = (TextView) replaySettingDialog.findViewById(R.id.srt_replay_set_dialg_reset);
