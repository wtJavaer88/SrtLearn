...
public abstract class SBaseLearnActivity extends BaseHorActivity
{
    ...
    public static final int MESSAGE_GET_ALL_SRT_PLAYED = 102;
    public static final int MESSAGE_GET_ALL_SRT_UNPLAYED = 103;
    public static final int MESSAGE_GET_ERROR_SRT = 104;
