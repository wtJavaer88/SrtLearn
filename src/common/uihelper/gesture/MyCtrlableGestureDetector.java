...
public class MyCtrlableGestureDetector extends SimpleOnGestureListener
{
	 ...
	 * @param context
	 */
	public MyCtrlableGestureDetector(Activity context, double scaleX, double scaleY, CtrlableHorGestureDetectorListener listener, CtrlableVerGestureDetectorListener listener2)
	{
